        ...
        if 'stream' in msg:
            ...
            if msg['stream'] == f'{self.ls}@kline_{self.ki}':
                ...
                if closed == True:
                    ...
                    # print(open, close, open_1, close_1)
                    # print(long_condition, short_condition, cLong, cSHort)
                ...
                #         if self.max_profit < lurp:
                #             self.max_profit = lurp
                ...
                #         if self.max_profit < surp:
                #             self.max_profit = surp
